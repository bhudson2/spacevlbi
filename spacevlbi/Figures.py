...
def UvPlot(spaceTelescopes, groundTelescopes, allsky, plotLost=1):
    """Plot (u,v) coverage generated by simulated array of target source.

       Args:
           spaceTelescopes (obj): Array of SpaceTelescope objects
           groundTelescopes (obj): Array of GroundTelescope objects
           plotLost (BOOL): Plot baselines lost due to functional constraints?
...
def AttitudeSphere(spaceTelescopes, telescopeSelect=0, azim=45, elev=30, \
    ...
    """Plot attitude sphere of spacecraft in the body-fixed frame. Earth, Sun
       ...
       Args:
           spaceTelescopes (obj): Array of SpaceTelescope objects
           telescopeSelect (int): Index of spaceTelescope array to plot attitude
                                 sphere of 
           elev (float): Plot viewing angle. Elevation in z plane.
           axim (float): Plot viewing angle. Azimuth measured in x-y plane.
           plotAntenna (BOOL): Flag controlling whether antenna is plotted
           plotSTR (BOOL): Flag controlling whether star trackers are plotted
           plotRad (BOOL): Flag controlling whether radiator is plotted
           plotComms (BOOL): Flag controlling whether comms system is plotted
           plotPanels (BOOL): Flag controlling whether panels are plotted
           plotEarth (BOOL): Flag controlling whether Earth vector is plotted
           plotSun (BOOL): Flag controlling whether Sun vector is plotted
           plotMoon (BOOL): Flag controlling whether Moon vector is plotted
    """   
...
def SolarPanelIncidence(spaceTelescopes, telescopeSelect, simTime):
...
def GroundStationElevation(spaceTelescopes, telescopeSelect, groundStations,\
                           simTime):
